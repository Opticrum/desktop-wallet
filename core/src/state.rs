...
impl Store {
  ...
  pub fn node_runtime(&self) -> NodeRuntime {
    NodeRuntime {
      ...
      fiber_addr: Some(format!(
        "{}/p2p/02ab91f4c5d27b8e6a1f4d3c9a72e881f0c5b7d4e3a9f8b6c1d2e5f4a3b7c9d1",
        self.config.fiber.listening_addr
      )),
...
mod tests {
  ...
  fn runtime_watchtower_is_standalone() {
    ...
    assert_eq!(
      r.watchtower.endpoint.as_deref(),
      Some("/ip4/45.77.65.221/tcp/8115")
    );
  }
}
