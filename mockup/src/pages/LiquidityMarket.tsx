  ...
  return (
    <div className="page-wide">
      ...
      <div className="lm-layout">
        ...
        {/* ── Right aside: connection + yield distribution ─────────── */}
        <div className="lm-aside">
          {/* Connection */}
          <div className="panel lm-connection-panel">
            <h3 className="section-label">{t.connectionPanel}</h3>
            ...
            <button
              type="button"
              className="btn-primary lm-connect-button"
